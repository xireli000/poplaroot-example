package poplaroot.core.example.DualPlugExample.demonstration12;
...
import poplaroot.core.example.DualPlugExample.demonstration12.demo.Example;
...
public class Main {
    ...
    public static void demonstration() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        DualPlugProxyInfo<Example> proxyToo = PoplarootProxy.getPoplarootProxy().getProxyAndSetInterceptor(Example.class, methodName,paramTypes,returnType, new ProxyInterceptor() {
            @Override
            public Object interceptor(Object thisProxy, Class<?> supperClass, Method method, Object[] allArguments, Callable<?> callable) {
                System.out.println("动态代理:"+method.getName());
